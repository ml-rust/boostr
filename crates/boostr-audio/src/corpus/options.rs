...
/// ([`MAX_ENCODE_SAMPLES`](boostr::model::audio::neucodec::MAX_ENCODE_SAMPLES)),
...
/// trains on: [`SpeechVocab`](boostr::model::speech_lm::SpeechVocab) keeps text
...
pub struct CorpusOptions<'a> {
    ...
    ///
    /// This exists because
    /// [`SpeechLayout::ExpressiveTts`](boostr::model::speech_lm::SpeechLayout)
    ...
    /// Run [`enhance`](crate::enhance::enhance) over each
