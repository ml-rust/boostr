...
//! run.
//!
//! [`SpeechCorpusBuilder`]: boostr_audio::corpus::SpeechCorpusBuilder
...
/// bundled — which is exactly what boostr's `vocab-llama3` feature does. This
/// crate never enables it, so the test holds for every build of this crate.
#[test]
